...
if __name__ == "__main__":
    ...
    userOpenapiKey = 'yyy'
    #国内和海外地址不同，根据需求进行切换
    request_url =  'https://crashsight.qq.com/uniform/openapi/queryIssueList'
    #
    body = {"exceptionTypeList":"Crash,Native","pid":"1","sortOrder":"desc","status":"0,2","sortField":"uploadTime","appId":"3729de3c06","platformId":10,"skipQueryHbase":True,"rows":10}
