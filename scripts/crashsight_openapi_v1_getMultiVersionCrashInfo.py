...
if __name__ == "__main__":
    ...
    #国内和海外地址不同，根据需求进行切换
    #新加坡地址
    #request_url = 'https://crashsight.wetest.net/uniform/openapi/getMultiVersionCrashInfo'
    #国内地址
    request_url = 'https://crashsight.qq.com/uniform/openapi/getMultiVersionCrashInfo'
    #批量openid请求
    body = {"requestid":"4f395abb53e82a1e1f57c7c86feb4cc4","stime":"2022-07-26 00:40:00","etime":"2022-07-28 00:00:00","type":"pretty","params":{"productVersion":"*"}}
