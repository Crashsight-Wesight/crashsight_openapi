...
if __name__ == "__main__":
    ...
    app_id = 'XXX'
    app_key = 'xxx'
    request_url = 'https://crashsight.qq.com/uniform/openapi/getCrashStat/platformId/2'
    #批量openid请求
    body = {"requestid":"4f395abb53e82a1e1f57c7c86feb4cc4","stime":"2022-05-02","etime":"2022-05-03","params":{"SubModuleId":"1251206376200339968","productVersion":"1.18*"},"type":"pretty","limit":1}
    # print(request_url)
