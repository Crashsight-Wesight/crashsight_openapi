...
if __name__ == "__main__":
    ...
    app_id = 'XXX'
    app_key = 'xxx'
    request_url = 'https://crashsight.qq.com/uniform/openapi/getSubModuleCrashInfo/platformId/2'
    #批量openid请求
    body = {"requestid":"4f395abb53e82a1e1f57c7c86feb4cc4","stime":"2022-07-05 00:00:00","etime":"2022-07-06 00:00:00","filters":{"SubModuleId":["1251206376200339968"]},"type":"pretty","limit":1}
    # print(request_url)
