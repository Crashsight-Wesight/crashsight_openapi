...
if __name__ == "__main__":
    ...
    app_id='xxx'
    request_url = 'https://crashsight.qq.com/uniform/openapi/getRealTimeAppendStat/appId/' + \
                  app_id + '/platformId/1/version/-1/' + \
                  'startHour/2023080100/endHour/202308031223/type/crash?fsn=4d8a5f7f-935e-4d7a-be35-d4edb2424fb5'
    # print(request_url)
