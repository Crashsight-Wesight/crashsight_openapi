...
if __name__ == "__main__":
    ...
    #国内和海外地址不同，根据需求进行切换
    request_url =  'https://crashsight.qq.com/uniform/openapi/getTrendEx'

    #
    body = {"appId":"3729de3c06","platformId":1,"type":"crash","dataType":"trendData","vm":0,"startDate":"20230727","endDate":"20230802","mergeMultipleVersionsWithInaccurateResult":False,"version":"-1","needCountryDimension":False,"countryList":[]}
