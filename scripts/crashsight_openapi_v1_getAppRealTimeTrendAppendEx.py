...
if __name__ == "__main__":
    ...
    #国内和海外地址不同，根据需求进行切换
    request_url =  'https://crashsight.qq.com/uniform/openapi/getAppRealTimeTrendAppendEx'

    #
    body = {"appId":"3729de3c06","platformId":1,"type":"crash","vm":0,"dataType":"realTimeTrendData","mergeMultipleVersionsWithInaccurateResult":False,"version":"-1","startDate":"2023080300","endDate":"2023080323","needCountryDimension":False,"countryList":[]}
