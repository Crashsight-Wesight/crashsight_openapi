...
if __name__ == "__main__":
    ...
    app_id = '7XXX'
    app_key = 'XXX'
    request_url = 'https://crashsight.qq.com/uniform/openapi/crashList/crashDataType/undefined?start=0&searchType=detail&exceptionTypeList=Crash%2CNative%2CExtensionCrash&pid=10&platformId=10&issueId=a4c2b53111bf91019233dca6d13b73cc&rows=10&appId='+app_id+'&fsn=3481e464-1391-467c-bfb2-df9002e49dd7'
    # print(request_url)
