...
if __name__ == "__main__":
    ...
    localUserId = '12453'
    userOpenapiKey = 'f60e9c94-9c6b-4629-8b35-53d47062d3af'

    #The domestic and overseas addresses are different; switch according to the requirements.
    #Android
    request_url =  'https://crashsight.qq.com/uniform/openapi/getCrashUserList/platformId/1'
    #IOS
    #request_url =  'https://crashsight.qq.com/uniform/openapi/getCrashUserList/platformId/2'

    #Batch OpenID request
    body = {"stime":"2023-08-02 00:00:00","etime":"2023-08-03 00:00:00","appId":"3729de3c06"}
