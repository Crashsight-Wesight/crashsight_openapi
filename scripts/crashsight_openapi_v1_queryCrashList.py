...
if __name__ == "__main__":
    ...
    userOpenapiKey = 'xxx'
    app_id = '3729de3c06'
    request_url = 'https://crashsight.qq.com/uniform/openapi/queryCrashList'

    body = {"appId": "3729de3c06", "platformId": 1, "rows": 10, "start": "0", "sortField": "crashTime", "desc": true,
            "searchConditionGroup": {"conditions": [{"field": "version"},
                                                    {"field": "crashUploadTime", "queryType": "RANGE_RELATIVE_DATETIME",
                                                     "gte": 604800000}, {"field": "crashDetail"}]}}
    # print(request_url)
