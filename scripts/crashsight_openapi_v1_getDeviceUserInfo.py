...
if __name__ == "__main__":
    ...
    app_id = 'XXX'
    app_key = 'XXX'
    request_url = 'https://crashsight.qq.com/uniform/openapi/getDeviceUserInfo/platformId/2/'
    #批量device请求
    body = {"etime":"2022-01-13 00:00:00","filters":{"deviceId":["BCAC3972-BDEF-4838-BC12-6A5E8FF57B50"]},"requestid":"59c8117e9e470a7e86215f4e91b039e2","source":0,"stime":"2022-01-09 00:00:00"}
    # print(request_url)
