...
if __name__ == "__main__":
    ...
    app_id = 'XXX'
    app_key = 'XXX'
    request_url = 'https://crashsight.qq.com/uniform/openapi/issueList?searchType=errorType&exceptionTypeList=Crash%2CNative&sortOrder=desc&sortField=uploadTime&' + \
                  app_id + '&platformId=1&rows=50&fsn=30770501-34fa-475c-b81a-6539addc4975'
    # print(request_url)
